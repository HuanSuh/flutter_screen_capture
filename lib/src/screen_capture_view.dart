...
typedef ScreenCaptureBuilder = Widget Function(BuildContext context, ScreenCaptureController controller);
typedef ScreenCaptureLayoutBuilder = Widget Function(
    BuildContext context, ScreenCaptureController controller, Widget captureView);
...
class _ScreenCaptureViewState extends State<ScreenCaptureView> {
  final WidgetsToImageController widgetToImageController = WidgetsToImageController();

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<ScreenCaptureController>(
      create: (_) => ScreenCaptureController._(
        widget.showPreview,
        widget.pixelRatio,
          ...
          return Stack(
            children: [
              WidgetsToImage(
                ...
                child: widget.layoutBuilder.call(
                  ctx,
                  ctrl,
                  RepaintBoundary(
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        ...
                        children: [
                          if (ctrl.isOnCapture && widget.watermark != null) widget.watermark!,
              ...
              if (ctrl._onCapture)
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    color: ctrl._state == _ScreenCaptureState.capture ? Colors.black54 : Colors.black26,
                    alignment: Alignment.center,
              ...
              if (ctrl._state == _ScreenCaptureState.preview && ctrl._previewFile != null)
                Material(
