...
class _BottomSheet extends StatefulWidget {
  ...
  /// Defines minimum and maximum sizes for a [_BottomSheet].
  ///
...
/// display the [_BottomSheet] when set to `true`. This is useful in the case
/// that a modal [_BottomSheet] needs to be displayed above all other content
...
/// modal bottom sheets (see the documentation for these on [_BottomSheet]
/// for more details).
///
...
/// See also:
///
///  * [_BottomSheet], which becomes the parent of the widget returned by the
